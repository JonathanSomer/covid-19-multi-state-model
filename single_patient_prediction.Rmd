...
We shall provide estimates for a 55 year old male hospitalized in a severe condition. Predictions below are done from time of hospitalization but estimates can be predicted from any time since hospitalization.
...
(This is computed using a weighted bootstrap based on 100 models, i.e 100 models each running 20K monte carlo simulations. This is slow and is recommended primarily in order to understand the quality of esimations. A faster alternative is look at the tables provided in with the paper.)
