...
get_modified_mild_or_moderate_to_deceased_cox_model = function(model, dataset, terminal_states, update_covariates, verbose){
  ...
  modified_covariates = data.frame(
    ...
    'type0-3or4' = as.numeric(type0_3_or_4),
...
get_modified_recovered_or_oohq_to_mild_or_moderate_cox_model = function(model, dataset, terminal_states, update_covariates, verbose){
